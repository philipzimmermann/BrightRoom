...
inline auto FC(Halide::Var x, Halide::Var y, Halide::Expr filters) -> Halide::Func {
    Halide::Func fc("fc");
    fc(x, y) = Halide::cast<uint16_t>(filters >> (((y << 1 & 14) | (x & 1)) << 1) & 3);
    return fc;
}

inline auto BlackLevel(Halide::Func input, Halide::Var x, Halide::Var y, Halide::Func fc, Halide::Expr black,
                       Halide::Func cblack) -> Halide::Func {
...
inline auto WhiteLevel(Halide::Func input, Halide::Var x, Halide::Var y, Halide::Expr white) -> Halide::Func {
    Halide::Func output("white_level");

    // Convert to float, divide by white level, and clamp between 0 and 1
    output(x, y) = Halide::clamp(Halide::cast<float>(input(x, y)) / white, 0.0f, 1.0f);
...
inline auto LogSum(Halide::Func input, Halide::Var x, Halide::Var y, Expr width, Expr height) -> Halide::Func {
...
inline auto Luminance(Halide::Func input, Halide::Expr x, Halide::Expr y) -> Halide::Expr {
    return 0.2126f * input(x, y, 0) + 0.7152f * input(x, y, 1) + 0.0722f * input(x, y, 2);
}

inline auto ToneMapping(Halide::Func input, Halide::Var x, Halide::Var y, Halide::Var c, Expr log_avg,
                        Expr key_value = 0.18f) -> Halide::Func {
    Halide::Func tone_mapped("tone_mapped");

    Halide::Expr scale_factor = key_value / log_avg;

    Halide::Expr lum = Luminance(input, x, y);
...
inline auto Exposure(Halide::Func input, Halide::Var x, Halide::Var y, Halide::Var c, Expr exposure) -> Halide::Func {
...
inline auto ContrastAdjustment(Halide::Func input, Halide::Var x, Halide::Var y, Halide::Var c, Expr contrast_factor,
                               Expr midpoint = 0.5f) -> Halide::Func {
